"""
Redirect requests to different urls, as determined by the payload.
...
JENKINS_HOST = 'test-jenkins.testeng.edx.org'
...
def request(context, flow):
    ...
    """
    # flow.request.host = JENKINS_HOST
    # flow.request.update_host_header()

    if flow.request.method == 'FOO':
